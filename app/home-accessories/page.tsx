...
export default function homeaccessoriesPage() {
  ...
  useEffect(() => {
    async function homeaccessories() {
      // 🚨 Notice the .eq() here! It ONLY fetches Womenswear!
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .ilike('category', '%home %'); // Looks for "Womenswear" or "Women"
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans pb-20">
      ...
      <div className="bg-black text-white py-16 px-4 text-center">
        <h1 className="text-4xl sm:text-5xl font-extrabold uppercase tracking-widest mb-4">home accessories</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-gray-500 text-lg">No products found in home accessories yet.</div>
        ) : (
