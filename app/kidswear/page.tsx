  ...
  useEffect(() => {
    async function fetchKidswear() {
      ...
      const { data, error } = await supabase
        .from('products')
        .select('*')
        .ilike('category', '%Kids%'); // Looks for "Womenswear" or "Women"
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] font-sans pb-20">
      ...
      <div className="bg-black text-white py-16 px-4 text-center">
        <h1 className="text-4xl sm:text-5xl font-extrabold uppercase tracking-widest mb-4">Kidswear</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-gray-500 text-lg">No products found in kidswear yet.</div>
        ) : (
